...
var G__31623 = devtools.prefs.pref(v);
v = G__31623;
continue;
} else {
return v;
...
}catch (e31630){var _e__29671__auto__ = e31630;
return false;
}})();
...
}catch (e31634){var _e__29671__auto__ = e31634;
return false;
}})();
...
}catch (e31636){var _e__29671__auto__ = e31636;
return false;
}}
}
});
...
var vec__31638 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31638,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31638,(1),null);
...
return cljs.core.some((function (p1__31647_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__31647_SHARP_);
}),template);
});
