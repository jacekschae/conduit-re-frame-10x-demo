...
var G__25980 = o;
(G__25980[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__25982__i < G__25982__a.length) {G__25982__a[G__25982__i] = arguments[G__25982__i + 0]; ++G__25982__i;}
  args = new cljs.core.IndexedSeq(G__25982__a,0,null);
} 
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__25985){
...
var props = map__25986__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25986__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25988){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25989__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__25989,map__25989__$1,on_write){
return (function (){
...
});})(node_value,map__25989,map__25989__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__25994){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25995__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25995__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__25997 = jsprops;
(G__25997["defaultValue"] = value);

(G__25997["onChange"] = ((function (G__25997,v,value,on_change,on_change__$1,map__25995,map__25995__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__25991_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__25991_SHARP_);
});})(G__25997,v,value,on_change,on_change__$1,map__25995,map__25995__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__26001 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26001,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26001,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26001,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___26005 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___26005 == null)){
} else {
var key_26006 = temp__5461__auto___26005;
(jsprops["key"] = key_26006);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__26009){
...
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26010__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__26012 = reagent.impl.template.__GT_NativeWrapper();
(G__26012["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__26013 = wrapped;
(G__26013["syntheticInput"] = true);

return G__26013;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__26014 = wrapped__$1;
(G__26014["syntheticOnChange"] = on_change);

return G__26014;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__26015 = wrapped__$2;
(G__26015["syntheticOnUpdate"] = on_update);
...
var len__4497__auto___26034 = arguments.length;
var i__4498__auto___26035 = (0);
while(true){
if((i__4498__auto___26035 < len__4497__auto___26034)){
args__4500__auto__.push((arguments[i__4498__auto___26035]));

var G__26036 = (i__4498__auto___26035 + (1));
i__4498__auto___26035 = G__26036;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26032){
var G__26033 = cljs.core.first(seq26032);
var seq26032__$1 = cljs.core.next(seq26032);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__26033,seq26032__$1);
});
...
break;
default:
var G__26046 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__26046;
continue;
...
var n__4376__auto___26056 = a.length;
var i_26057 = (0);
while(true){
if((i_26057 < n__4376__auto___26056)){
(a[i_26057] = reagent.impl.template.as_element((a[i_26057])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4376__auto___26059 = a.length;
var i_26060 = (0);
while(true){
if((i_26060 < n__4376__auto___26059)){
var val_26061 = (a[i_26060]);
if(((cljs.core.vector_QMARK_(val_26061)) && ((reagent.impl.template.key_from_vec(val_26061) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26060] = reagent.impl.template.as_element(val_26061));

var G__26062 = (i_26060 + (1));
i_26060 = G__26062;
continue;
} else {
}
...
var ctx = ({});
var vec__26063 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26063,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26063,(1),null);
...
var G__26068 = (cljs.core.count(argv) - first_child);
switch (G__26068) {
case (0):
...
case (1):
var G__26070 = comp;
var G__26071 = jsprops;
var G__26072 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__26070,G__26071,G__26072);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__26068){
