...
var G__27895 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","invoke-error","repl/invoke-error",839951858),new cljs.core.Keyword(null,"error","error",-978969032),e.message], null);
if(cljs.core.truth_(e.hasOwnProperty("stack"))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27895,new cljs.core.Keyword(null,"stack","stack",-793405930),e.stack);
} else {
return G__27895;
}
});
...
var _STAR_default_data_reader_fn_STAR_27899 = cljs.tools.reader._STAR_default_data_reader_fn_STAR_;
cljs.tools.reader._STAR_default_data_reader_fn_STAR_ = ((function (_STAR_default_data_reader_fn_STAR_27899){
...
}finally {cljs.tools.reader._STAR_default_data_reader_fn_STAR_ = _STAR_default_data_reader_fn_STAR_27899;
}});
shadow.cljs.devtools.client.env.make_task_fn = (function shadow$cljs$devtools$client$env$make_task_fn(p__27901,p__27902){
...
var log_missing_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27903__$1,new cljs.core.Keyword(null,"log-missing-fn","log-missing-fn",732676765));
var log_call_async = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27903__$1,new cljs.core.Keyword(null,"log-call-async","log-call-async",183826192));
var log_call = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27903__$1,new cljs.core.Keyword(null,"log-call","log-call",412404391));
...
var fn_sym = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27904__$1,new cljs.core.Keyword(null,"fn-sym","fn-sym",1423988510));
var fn_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27904__$1,new cljs.core.Keyword(null,"fn-str","fn-str",-1348506402));
var async = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27904__$1,new cljs.core.Keyword(null,"async","async",1050769601));
return ((function (map__27903,map__27903__$1,log_missing_fn,log_call_async,log_call,map__27904,map__27904__$1,fn_sym,fn_str,async){
...
;})(map__27903,map__27903__$1,log_missing_fn,log_call_async,log_call,map__27904,map__27904__$1,fn_sym,fn_str,async))
});
shadow.cljs.devtools.client.env.do_js_reload_STAR_ = (function shadow$cljs$devtools$client$env$do_js_reload_STAR_(p__27910){
...
var task = first__27913;
var remaining_tasks = seq__27912__$1;
if(cljs.core.truth_(task)){
var G__27916 = ((function (vec__27911,seq__27912,first__27913,seq__27912__$1,task,remaining_tasks){
return (function (){
...
});})(vec__27911,seq__27912,first__27913,seq__27912__$1,task,remaining_tasks))
;
return (task.cljs$core$IFn$_invoke$arity$1 ? task.cljs$core$IFn$_invoke$arity$1(G__27916) : task.call(null,G__27916));
} else {
return null;
}
});
...
shadow.cljs.devtools.client.env.do_js_reload.cljs$core$IFn$_invoke$arity$3 = (function (p__27921,load_code_fn,complete_fn){
var map__27922 = p__27921;
var map__27922__$1 = ((((!((map__27922 == null)))?(((((map__27922.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27922.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27922):map__27922);
var msg = map__27922__$1;
var reload_info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27922__$1,new cljs.core.Keyword(null,"reload-info","reload-info",1648088086));
var load_tasks = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (map__27922,map__27922__$1,msg,reload_info){
return (function (p1__27917_SHARP_){
return shadow.cljs.devtools.client.env.make_task_fn(msg,p1__27917_SHARP_);
});})(map__27922,map__27922__$1,msg,reload_info))
,new cljs.core.Keyword(null,"before-load","before-load",-2060117064).cljs$core$IFn$_invoke$arity$1(reload_info)))),((function (map__27922,map__27922__$1,msg,reload_info){
return (function (next){
(load_code_fn.cljs$core$IFn$_invoke$arity$0 ? load_code_fn.cljs$core$IFn$_invoke$arity$0() : load_code_fn.call(null));

return (next.cljs$core$IFn$_invoke$arity$0 ? next.cljs$core$IFn$_invoke$arity$0() : next.call(null));
});})(map__27922,map__27922__$1,msg,reload_info))
),cljs.core.map.cljs$core$IFn$_invoke$arity$1(((function (map__27922,map__27922__$1,msg,reload_info){
return (function (p1__27918_SHARP_){
return shadow.cljs.devtools.client.env.make_task_fn(msg,p1__27918_SHARP_);
});})(map__27922,map__27922__$1,msg,reload_info))
),new cljs.core.Keyword(null,"after-load","after-load",-1278503285).cljs$core$IFn$_invoke$arity$1(reload_info)),((function (map__27922,map__27922__$1,msg,reload_info){
return (function (next){
