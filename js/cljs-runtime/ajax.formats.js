...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__39187){
...
var request = map__39188__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39188__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__39192 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__39192.cljs$core$IFn$_invoke$arity$1 ? fexpr__39192.cljs$core$IFn$_invoke$arity$1(response) : fexpr__39192.call(null,response));
});

ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__39193 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__39193.cljs$core$IFn$_invoke$arity$1 ? fexpr__39193.cljs$core$IFn$_invoke$arity$1(response) : fexpr__39193.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__39195){
...
var request = map__39196__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39196__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
