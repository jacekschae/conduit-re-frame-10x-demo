...
var G__29802 = cljs.core.PersistentArrayMap.EMPTY;
var G__29803 = native_stack_trace;
var G__29804 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__29805 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__29802,G__29803,G__29804,G__29805) : cljs.stacktrace.parse_stacktrace.call(null,G__29802,G__29803,G__29804,G__29805));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29813__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29813__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29813__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e29812){var _e = e29812;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___29836 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5455__auto___29836)){
var seen_errors_29837 = temp__5455__auto___29836;
if(cljs.core.truth_(seen_errors_29837.has(self))){
} else {
seen_errors_29837.add(self);

var temp__5457__auto___29838 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5457__auto___29838)){
var sense_29839 = temp__5457__auto___29838;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29839)].join('');
} else {
}
}
} else {
