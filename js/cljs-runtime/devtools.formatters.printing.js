...
var len__4497__auto___31686 = arguments.length;
var i__4498__auto___31687 = (0);
while(true){
if((i__4498__auto___31687 < len__4497__auto___31686)){
args__4500__auto__.push((arguments[i__4498__auto___31687]));

var G__31688 = (i__4498__auto___31687 + (1));
i__4498__auto___31687 = G__31688;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31683){
var G__31684 = cljs.core.first(seq31683);
var seq31683__$1 = cljs.core.next(seq31683);
var G__31685 = cljs.core.first(seq31683__$1);
var seq31683__$2 = cljs.core.next(seq31683__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__31684,G__31685,seq31683__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31693_SHARP_){
return !((cljs.core.meta(p1__31693_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31736__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31740){var _e__29671__auto__ = e31740;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e31742){var _e__29671__auto__ = e31742;
return false;
}}
})())){
...
var _STAR_current_state_STAR_31750 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state();

try{var map__31751 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31751__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_31750;
}});
...
;
var temp__5455__auto___31757 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5455__auto___31757)){
var managed_print_level_31759 = temp__5455__auto___31757;
var _STAR_print_level_STAR_31754_31761 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_31759;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR_31754_31761,managed_print_level_31759,temp__5455__auto___31757,writer,opts,job_fn){
return (function (p1__31753_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31753_SHARP_,null);
});})(_STAR_print_level_STAR_31754_31761,managed_print_level_31759,temp__5455__auto___31757,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_31754_31761;
}} else {
job_fn();
}
