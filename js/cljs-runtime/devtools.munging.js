...
var o30623 = temp__5455__auto__;
var temp__5455__auto____$1 = (o30623["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o30624 = temp__5455__auto____$1;
return (o30624["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29658__auto__ = f;
return (o__29658__auto__["toString"]).call(o__29658__auto__);
} else {
return "";
}
...
try{var o__29658__auto___30668 = t;
(o__29658__auto___30668["cljs$lang$ctorPrWriter"]).call(o__29658__auto___30668,t,writer);
}catch (e30667){var __30670 = e30667;
}
...
var char_code = (function (){var o__29658__auto__ = (new String(char$));
return (o__29658__auto__["charCodeAt"]).call(o__29658__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29658__auto__ = String;
return (o__29658__auto__["fromCharCode"]).call(o__29658__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30684 = num_code;
switch (G__30684) {
case (1):
return (185);
...
var o__29658__auto__ = String;
return (o__29658__auto__["fromCharCode"]).call(o__29658__auto__,superscript_code);
});
/**
...
}catch (e30704){var _e__29671__auto__ = e30704;
return false;
}})())){
...
var vec__30705 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30705,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o30742 = temp__5455__auto__;
var temp__5455__auto____$1 = (o30742["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o30743 = temp__5455__auto____$1;
return (o30743["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4497__auto___30764 = arguments.length;
var i__4498__auto___30765 = (0);
while(true){
if((i__4498__auto___30765 < len__4497__auto___30764)){
args__4500__auto__.push((arguments[i__4498__auto___30765]));

var G__30766 = (i__4498__auto___30765 + (1));
i__4498__auto___30765 = G__30766;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30756){
var vec__30757 = p__30756;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30757,(0),null);
...
var G__30768 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__30769 = cljs.core.butlast(remaining_tokens);
name_tokens = G__30768;
remaining_tokens = G__30769;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30749){
var G__30750 = cljs.core.first(seq30749);
var seq30749__$1 = cljs.core.next(seq30749);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__30750,seq30749__$1);
});
...
var vec__30780 = cljs.core.split_with((function (p1__30775_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30775_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30780,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30780,(1),null);
...
var vec__30787 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30787,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30787,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__30790 = cljs.core.rest(remaining_tokens);
var G__30791 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__30790;
name_tokens = G__30791;
continue;
} else {
...
var vec__30797 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30797,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30797,(1),null);
var vec__30800 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30800,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30800,(1),null);
var vec__30803 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30803,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30803,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30803,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30803,(3),null);
...
var vec__30815 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30815,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30815,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30815,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30815,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30815,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30815,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__30828 = temp__5455__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30828,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30828,(1),null);
var vec__30831 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__30838 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__30838) : devtools.munging.parse_fn_info_deep.call(null,G__30838));
})()));
}
} else {
return fn_info;
...
var G__30853 = (arity + (1));
var G__30854 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__30873_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__30874_SHARP_);
...
var args__4500__auto__ = [];
var len__4497__auto___30883 = arguments.length;
var i__4498__auto___30884 = (0);
while(true){
if((i__4498__auto___30884 < len__4497__auto___30883)){
args__4500__auto__.push((arguments[i__4498__auto___30884]));

var G__30885 = (i__4498__auto___30884 + (1));
i__4498__auto___30884 = G__30885;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30878){
var vec__30879 = p__30878;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30879,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30876){
var G__30877 = cljs.core.first(seq30876);
var seq30876__$1 = cljs.core.next(seq30876);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__30877,seq30876__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30915__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30915__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30915__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30915__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30916 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30916,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30916,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30916,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30916,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30916,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30916,(5),null);
...
var o__29658__auto__ = f;
return (o__29658__auto__["getBasis"]).call(o__29658__auto__);
});
/**
...
}catch (e30989){var _e__29671__auto__ = e30989;
...
var G__31002 = (obj[cljs.core.first(path)]);
var G__31003 = cljs.core.rest(path);
obj = G__31002;
path = G__31003;
continue;
} else {
...
return (function (accum,p__31031){
var vec__31035 = p__31031;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31035,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31035,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__31063){
var vec__31065 = p__31063;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31065,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31065,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31065,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31091,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31091,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__31091,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__31087_SHARP_){
return (obj[cljs.core.first(p1__31087_SHARP_)]);
});})(name,sorted_matches,vec__31091,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
