...
return mranderson047.reagent.v0v7v0.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(x);
});
...
return cljs.core.native_satisfies_QMARK_(mranderson047.reagent.v0v7v0.reagent.ratom.IReactiveAtom,x);
} else {
return false;
}
}
...
return mranderson047.reagent.v0v7v0.reagent.ratom.make_reaction(f);
});
...
return mranderson047.reagent.v0v7v0.reagent.ratom.add_on_dispose_BANG_(a_ratom,f);
});
...
return mranderson047.reagent.v0v7v0.reagent.ratom.dispose_BANG_(a_ratom);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__24853 = cljs.core.instance_QMARK_;
var expr__24854 = reactive_val;
if(cljs.core.truth_((pred__24853.cljs$core$IFn$_invoke$arity$2 ? pred__24853.cljs$core$IFn$_invoke$arity$2(mranderson047.reagent.v0v7v0.reagent.ratom.RAtom,expr__24854) : pred__24853.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.RAtom,expr__24854)))){
return "ra";
} else {
if(cljs.core.truth_((pred__24853.cljs$core$IFn$_invoke$arity$2 ? pred__24853.cljs$core$IFn$_invoke$arity$2(mranderson047.reagent.v0v7v0.reagent.ratom.RCursor,expr__24854) : pred__24853.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.RCursor,expr__24854)))){
return "rc";
} else {
if(cljs.core.truth_((pred__24853.cljs$core$IFn$_invoke$arity$2 ? pred__24853.cljs$core$IFn$_invoke$arity$2(mranderson047.reagent.v0v7v0.reagent.ratom.Reaction,expr__24854) : pred__24853.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.Reaction,expr__24854)))){
return "rx";
} else {
if(cljs.core.truth_((pred__24853.cljs$core$IFn$_invoke$arity$2 ? pred__24853.cljs$core$IFn$_invoke$arity$2(mranderson047.reagent.v0v7v0.reagent.ratom.Track,expr__24854) : pred__24853.call(null,mranderson047.reagent.v0v7v0.reagent.ratom.Track,expr__24854)))){
return "tr";
} else {
return "other";
}
