...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__26276 = cljs.core.instance_QMARK_;
var expr__26277 = reactive_val;
if(cljs.core.truth_((pred__26276.cljs$core$IFn$_invoke$arity$2 ? pred__26276.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__26277) : pred__26276.call(null,reagent.ratom.RAtom,expr__26277)))){
return "ra";
} else {
if(cljs.core.truth_((pred__26276.cljs$core$IFn$_invoke$arity$2 ? pred__26276.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__26277) : pred__26276.call(null,reagent.ratom.RCursor,expr__26277)))){
return "rc";
} else {
if(cljs.core.truth_((pred__26276.cljs$core$IFn$_invoke$arity$2 ? pred__26276.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__26277) : pred__26276.call(null,reagent.ratom.Reaction,expr__26277)))){
return "rx";
} else {
if(cljs.core.truth_((pred__26276.cljs$core$IFn$_invoke$arity$2 ? pred__26276.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__26277) : pred__26276.call(null,reagent.ratom.Track,expr__26277)))){
return "tr";
} else {
return "other";
}
